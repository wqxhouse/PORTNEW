...
namespace PORTAPP.Design
{
    ...
    public class SqlJournalPageRepository : WineDataDomain.IJournalPageRepository
    {
        ...
        public void GetUserPages(int w, int h, int wInput, int hInput, string username, System.Action<System.Collections.Generic.IEnumerable<WineDataDomain.JournalPage>, System.Exception> callback)
        {
